                ...
                <div class="row gx-5">
                    ...
                    <div class="col mx-1 mb-2 d-flex align-items-center flex-column" style="background-color: white; height: 250px;">
                        ...
                        <div class="row mb-2">
                            ...
                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#onegemModal">NT$49</button>
                            <!-- Modal -->
                            <div class="modal fade " id="onegemModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title d-inline-flex mx-auto" id="exampleModalLabel">購買鑽石</h5>
                                        </div>
                                        <div class="modal-body d-inline-flex mx-auto">
                                            <div class="row">
                                                <div class="col-4 d-inline-flex p-2"><img src="/img/gem2.png" alt=""></div>
                                                <div class="col d-flex align-items-center">購買後將獲得1顆鑽石</div>
                                            </div>
                                        </div>

                                        <div class="mx-auto d-inline-flex mb-3">
                                            <button type="button" class="btn btn-secondary mx-1" data-bs-dismiss="modal">取消</button>
                                            <div id="googlepay" class="col-1" style=" height: 40px;"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col mx-1 mb-2 d-flex align-items-center flex-column" style="background-color: white; height: 250px;">
                        ...
                        <div class="row mb-2">
                            ...
                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#onegemModal">NT$290</button>
                            <!-- Modal -->
                            <div class="modal fade" id="onegemModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
